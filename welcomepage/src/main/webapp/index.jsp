...
%>
    ...
    <section id="resources">
      <article>
        ...
        <ul>
          <li><a href="https://www.ibm.com/docs/en/odm/8.12.0" target="_blank">ODM Documentation</a></li>
          <li><a href="https://github.com/DecisionsDev/odm-for-container-getting-started/tree/8.12.0" target="_blank">Getting Started</a></li>
