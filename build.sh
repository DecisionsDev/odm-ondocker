...
if [ ! -f $HOME/.cache/$ODM_FILE_NAME ]; then
    ...
    ODM_ZIP_URL=https://hyc-odm-docker.artifactory.swg-devops.com/artifactory/hyc-odm-snapshot-maven-local/com/ilog/rules/cloud/docker-compose-build-images/${ODM_VERSION}/docker-compose-build-images-${ODM_VERSION}.zip
