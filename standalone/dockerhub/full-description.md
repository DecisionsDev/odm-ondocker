...
```console
docker run -e LICENSE=accept -p 9060:9060 -p 9453:9453  -e SAMPLE=true icr.io/cpopen/odm-k8s/odm:9.5
```
...
```console
docker run -e LICENSE=accept -p 9060:9060 -p 9453:9453 -u $(id -u) -v $PWD:/config/dbdata/ -e SAMPLE=false  icr.io/cpopen/odm-k8s/odm:9.5
```
